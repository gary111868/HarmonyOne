...
#[derive(Debug)]
pub struct HarmonyOneProcessor {
    verbose: bool,
    processed_count: usize,
}

impl HarmonyOneProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting HarmonyOne processing");
    
    let mut processor = HarmonyOneProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = HarmonyOneProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = HarmonyOneProcessor::new(false);
